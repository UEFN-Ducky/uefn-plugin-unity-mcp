#!/usr/bin/env python3
"""Zip + publish unity-mcp to the UEFN Ducky Store via uds_release.
...
Usage:
  ...
  py scripts/release.py --publish --changelog "v1.0.0: UNITY MCP bridge to Coplay Unity MCP"
"""
...
def publish(zip_path: Path, *, category: str, changelog: str) -> None:
    ...
    pid = str(manifest.get("id") or "unity-mcp")
